...
public final class Keys {
    ...
    public static NamespacedKey NUCLEAR_CORE_RECIPE = new NamespacedKey(JavaPlugin.getPlugin(NuclearWeapon.class), "nuclearCoreRecipe");
    public static NamespacedKey NUCLEAR_CORE = new NamespacedKey(JavaPlugin.getPlugin(NuclearWeapon.class), "nuclearCore");
